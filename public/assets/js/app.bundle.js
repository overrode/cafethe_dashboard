...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  // public/assets/js/components/saleForm.js
  var saleForm_default = () => ({
    items: [],
    ...
    selectedClientId: "",
    selectedClientName: "Client non renseign\xE9",
    openClientModal() {
    ...
    selectClient(option) {
      if (!option || !option.value) {
        ...
        this.selectedClientName = "Client non renseign\xE9";
      } else {
    ...
    async createClient() {
      ...
      try {
        ...
        if (!response.ok || !data2.success) {
          this.clientError = data2.message ?? "Erreur lors de la cr\xE9ation du client.";
          return;
        }
        this.selectedClientId = String(data2.client.id);
        this.selectedClientName = data2.client.name;
  ...
  module_default.data("saleForm", saleForm_default);
